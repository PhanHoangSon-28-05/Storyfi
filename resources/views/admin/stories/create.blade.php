                        ...
                        <div class="x_content">
                            ...
                            <form method="post" action="{{ route('stories.store') }}" id="demo-form" data-parsley-validate
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-sm-2 label-align" for="inputImage"
                                        style="font-weight: bold; font-size:15px;">Image
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6">
                                        <input class="form-control" type="text" data-validate-length-range="6"
                                            ...
                                            id="name" placeholder="Enter the title of the story here"
                                            required="required" />
                                        @error('name')
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-sm-2 label-align" for="summary"
                                        ...
                                        <span class="required" style="color: red;">*</span></label>
                                    <div class="col-md-9 col-sm-6">
                                        <textarea value="" id="editor" class="form-control" name="summary">{{ old('summary') }}</textarea>
                                        @error('summary')
                                            <span class="text-danger">{{ $message }}</span><br>
                                        @enderror
                                    </div>
                                ...
                                <div class="field item form-group" id="content" style="display: none;">
                                    <div class="field item form-group">
                                        <label class="col-form-label col-sm-2 label-align" for="content"
                                            ...
                                            <span class="required" style="color: red;">*</span></label>
                                        <div class="col-md-9 col-sm-6">
                                            <textarea value="" id="editor1" class="form-control" name="content" style="color: black;">{{ old('content') }}</textarea>
                                            @error('content')
                                                <span class="text-danger">{{ $message }}</span><br>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" id="draftButton">Bản
                                                    nháp</button>
