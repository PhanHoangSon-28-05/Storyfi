                            ...
                            <form method="post" action="{{ route('chapters.update', $chapters->id) }}" id="demo-form"
                                ...
                                <div class="field item form-group">
                                    <input class="form-control" type="text" type="text"
                                        value="{{ $chapters->story_id }}" name="story_id" style="display: none;">
                                    <label class="col-sm-2"></label>
                                    <label class="col-form-label col-sm-8 label-align" for="name"
                                        style="font-weight: bold; font-size:20px; text-align: center;">{{ $chapters->stories->name }}
                                    </label>
                                    <label class="col-sm-2"></label>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6">
                                        <input class="form-control" type="text" data-validate-length-range="6"
                                            data-validate-words="2" value="{{ old('name') ?? $chapters->name }}"
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-sm-2 label-align" for="sumary"
                                        style="font-weight: bold; font-size:15px;">Sumary
                                        <span class="required" style="color: red;">*</span></label>
                                    <div class="col-md-9 col-sm-6">
                                        <textarea value="" id="editor1" class="form-control" name="sumary" rows="12">{{ old('summary') ?? $chapters->sumary }}</textarea>
                                        @error('sumary')
                                            <span class="text-danger">{{ $message }}</span><br>
                                        @enderror
                                    </div>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-sm-2 label-align" for="content"
                                        ...
                                        <span class="required" style="color: red;">*</span></label>
                                    <div class="col-md-9 col-sm-6">
                                        <textarea value="" id="editor" class="form-control" name="content" rows="12">{{ old('content') ?? $chapters->content }}</textarea>
                                        @error('content')
                                            <span class="text-danger">{{ $message }}</span><br>
                                        @enderror
                                    </div>
