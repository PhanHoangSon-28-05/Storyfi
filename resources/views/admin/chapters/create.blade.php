                            ...
                            <form method="post" action="{{ route('chapters.store') }}" id="demo-form" data-parsley-validate
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-sm-2 label-align" for="sumary"
                                        ...
                                        <span class="required" style="color: red;">*</span></label>
                                    <div class="col-md-9 col-sm-6">
                                        <textarea value="" id="editor1" class="form-control sumary" name="sumary" style="color: black;">{{ old('summary') }}</textarea>
                                        @error('sumary')
                                            <span class="text-danger">{{ $message }}</span><br>
                                        @enderror
                                    </div>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-sm-2 label-align" for="content"
                                        ...
                                        <span class="required" style="color: red;">*</span></label>
                                    <div class="col-md-9 col-sm-6">
                                        <textarea value="" id="editor" class="form-control content" name="content" style="color: black;">{{ old('content') }}</textarea>
                                        @error('content')
                                            <span class="text-danger">{{ $message }}</span><br>
                                        @enderror
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
            ...
            placeholder: 'Chapter sumary here',
